export const translations = {
  es: {
    ...
    productAnalytics: {
      ...
      subtitle: "Métricas internas de uso de la plataforma. Solo equipo de producto.",
      privacyNote: "Datos agregados y anónimos. Nunca incluye información psicológica individual.",
      errorTitle: "No se pudo cargar el panel",
      errorBody: "Ejecuta supabase/product-analytics.sql y marca tu perfil como administrador de plataforma.",
      insightsTitle: "Insights",
      insightsSubtitle: "Anomalías y señales automáticas para mejorar el producto.",
      byClub: "Por club",
      byTeam: "Por equipo",
      topTopics: "Temas más vistos",
      noData: "Sin datos suficientes en este periodo.",
      featuresEmpty: "Aún no hay eventos de funcionalidades registrados.",
      navigationEmpty: "Aún no hay datos de navegación.",
      col: {
        club: "Club",
        team: "Equipo",
      ...
      kpi: {
        completion: "Completitud semanal",
        medianReview: "Mediana revisión",
        avgReview: "Media revisión",
        fastestReview: "Más rápida",
        slowestReview: "Más lenta",
        abandonRate: "Abandono",
        activeAthletes: "Deportistas",
        activeClubs: "Clubes activos",
        teams: "Equipos",
        psychologists: "Psicólogos",
        coaches: "Entrenadores",
        mtShown: "Entrenamiento mostrado",
        mtRead: "Lectura >3s",
        mtDismissed: "Descartado",
        apptTotal: "Citas",
        apptPending: "Pendientes",
        apptCompleted: "Completadas",
        apptCancelled: "Canceladas",
        msgTotal: "Mensajes",
        msgFromAthletes: "De deportistas",
        msgFromPsych: "De psicólogos",
        msgUnread: "Sin leer",
        alertsGenerated: "Avisos generados",
        alertsResolved: "Avisos revisados",
        prioritiesReviewed: "Prioridades revisadas",
        dau: "DAU (sesiones)",
        wau: "WAU (sesiones)",
        mau: "MAU (sesiones)",
        completedReviews: "Revisiones completadas",
        skippedWeeks: "Semanas omitidas (est.)",
        retentionWeekly: "Retención semanal",
        missedTwoWeeks: "Sin 2 semanas",
        growthAthletes7d: "Alta atletas 7d",
        growthAthletes30d: "Alta atletas 30d",
        growthClubs30d: "Alta clubs 30d",
        growthTeams30d: "Alta equipos 30d",
        psychWau: "Psicólogos WAU",
        psychViews: "Vistas psicólogo",
        psychNotes: "Notas creadas",
        coachWau: "Entrenadores WAU",
        coachViews: "Vistas entrenador",
        coachRecs: "Recomendaciones",
      },
      sections: {
        engagement: "Engagement deportista",
        engagementHint: "Tasa de revisión semanal completada.",
        reviewCompletion: "Completitud de revisión",
        reviewGoal: "Objetivo: menos de 60 segundos.",
        athleteActivity: "Actividad del deportista",
        athleteActivityHint: "Sesiones anónimas y participación agregada.",
        mentalTraining: "Entrenamiento Mental™",
        mentalTrainingHint: "Exposición y lectura (eventos anónimos).",
        platformHealth: "Salud de la plataforma",
        platformHealthHint: "Clubes, equipos, roles y crecimiento.",
        psychActivity: "Actividad del psicólogo",
        coachActivity: "Actividad del entrenador",
        appointments: "Citas",
        messages: "Mensajes",
        alerts: "Alertas y prioridades",
        featureAdoption: "Adopción de funcionalidades",
        featureAdoptionHint: "Eventos de uso por funcionalidad.",
        navigation: "Navegación",
        navigationHint: "Páginas más visitadas (anónimo).",
      },
      insight: {
        stable: "No se detectan anomalías relevantes esta semana.",
        completionDrop: "La tasa de completitud ha bajado un {delta}% respecto a la semana anterior.",
        completionUp: "La tasa de completitud ha subido un {delta}% respecto a la semana anterior.",
        reviewSlow: "La mediana de tiempo de revisión supera el objetivo ({seconds}s).",
        reviewAbandon: "El {pct}% de revisiones iniciadas no se completan.",
        abandonStep: "La mayoría de abandonos ocurren alrededor del paso {step}.",
        missedTwoWeeks: "El {pct}% de deportistas con historial llevan dos semanas sin revisar.",
        appointmentsPending: "Hay {count} solicitudes de cita pendientes sin resolver.",
        mentalTrainingEngagement: "El {pct}% de tarjetas de Entrenamiento Mental se leen más de 3 segundos.",
        unreadMessages: "Hay {count} mensajes sin leer acumulados.",
      },
    },
    ...
    privacy: {
      ...
      psychologistView:
        "El/la psicólogo/a tiene acceso profesional completo para seguimiento, alertas y exportación autorizada.",
      minors:
    ...
    teams: {
      ...
      headerSummary: "{teams} equipos · {athletes} deportistas",
      newTeamShort: "+ Nuevo equipo",
      createModalTitle: "Nuevo equipo",
      renameModalTitle: "Renombrar equipo",
      emptyTeams: "Aún no hay equipos.",
      cardAthletes: "👥 {count} deportistas",
      cardReviewsDone: "{count} revisiones semanales completadas",
      cardReviewsDoneGood: "🟢 {count} han completado la revisión esta semana",
      cardNoReviewsThisWeek: "🟡 Nadie ha completado la revisión esta semana",
      cardPending: "{count} pendientes",
      cardPendingGood: "🟡 {count} pendientes",
      cardAlerts: "{count} avisos",
      cardAlertsGood: "🔴 {count} aviso de seguimiento",
      copyInvitation: "📋 Copiar invitación",
      copyInvitationShort: "Copiar invitación",
      invitationCopied: "✔ Invitación copiada",
      invitationCopiedShort: "✔ Copiada",
      viewTeam: "Ver equipo",
      metricMental: "Estado mental medio",
      metricWellbeing: "Bienestar",
      metricSocial: "Cohesión social",
      metricCoach: "Comunicación entrenador",
      metricEnergy: "Energía",
      lastReviewLabel: "📅 Última revisión recibida:",
      lastReviewToday: "Hoy",
      lastReviewYesterday: "Ayer",
      lastReviewDaysAgo: "Hace {days} días",
      lastReviewNever: "Nunca",
      lastReviewNone: "Sin revisiones",
      lastReviewShort: "Última revisión:",
      last7Days: "Últimos 7 días",
      cardAthletesShort: "{count} deportistas",
      cardParticipation: "{done} esta semana · {pct}%",
      cardPendingShort: "{count} pendientes",
      cardAlertsShort: "{count} avisos",
      healthLabel: {
        healthy: "Rendimiento estable",
        monitoring: "Seguimiento recomendado",
      ...
      trendStableShort: "vs. semana anterior",
      trendDelta: "{delta} vs. semana anterior",
      alertFactorsTitle: "⚠ Factores principales",
      alertFactor: {
        mentalLow: "Estado mental por debajo del umbral",
        wellbeingLow: "Bienestar bajo",
        energyLow: "Energía baja",
        lowParticipation: "Participación semanal por debajo del {pct}%",
        unresolvedAlerts: "{count} avisos sin resolver",
        mentalDeclining: "Estado mental en descenso (−{delta})",
        pendingReviews: "{count} revisiones pendientes",
      },
      status: {
        stable: "🟢 Equipo estable",
        watch: "🟡 Seguimiento recomendado",
        observation: "🟠 Varios deportistas en observación",
        critical: "🔴 Seguimiento prioritario",
        unknown: "Sin datos suficientes",
      },
      menuActions: "Acciones del equipo",
    ...
    director: {
      ...
      alertsResolved: "Avisos resueltos (mes)",
      ...
      privacyNote: "Este panel no muestra notas profesionales, mensajes privados ni respuestas individuales.",
    },

    reports: {
      exportPdf: "Exportar informe de rendimiento psicológico",
      teamReport: "Informe de equipo",
      clubReport: "Informe de club",
      athleteReport: "Informe de rendimiento psicológico",
      monthlySubtitle: "Informe agregado — Zona Mental+",
      individualSubtitle: "Informe de rendimiento psicológico",
      ...
      disclaimer: "Aviso",
      disclaimerText: "Informe de apoyo a la toma de decisiones profesionales. No sustituye el juicio profesional.",
      team: "Equipo",
      club: "Club",
      athlete: "Deportista",
      teams: "Equipos",
      ...
      date: "Fecha",
      noTeams: "Sin equipos",
      sectionAiSummary: "Interpretación IA",
    ...
    athlete: {
      loading: "Preparando tu revisión...",
      ...
      homeWelcome: "Bienvenido/a a tu revisión semanal.",
      homeDuration: "Este proceso solo te llevará aproximadamente 45 segundos.",
      startReview: "Comenzar revisión",
      weekStatusLabel: "Revisión de esta semana",
      weekStatusPending: "Pendiente",
      weekStatusCompleted: "Completada",
      weekCompletedTitle: "¡Gracias!",
      weekCompletedBody: "La revisión de esta semana ya está completada.",
      weekCompletedSupport:
        "Tu participación ayuda a hacer un seguimiento continuo de tu rendimiento mental durante la temporada.",
      completionTitle: "Revisión completada",
      completionThanks: "Gracias por dedicar este tiempo.",
      completionBody:
        "Cada respuesta ayuda a tu psicólogo/a deportivo/a a entender mejor tu evolución durante la temporada.",
      completionHonesty:
        "Recuerda: no hay respuestas correctas o incorrectes. La honestidad es la parte más valiosa del proceso.",
      confidentiality:
        "La información que compartes es confidencial y solo es accesible por tu psicólogo/a deportivo/a, excepto aquellas recomendaciones que decida compartir con el equipo técnico con tu conocimiento.",
      actionAppointment: "Solicitar una cita",
      actionMessage: "Enviar un mensaje",
    ...
    entrenamentMental: {
      ...
      tryThisWeek: "Pruébalo esta semana.",
      currentWeek: "Semana actual",
      currentPhase: "Fase",
      currentTopic: "Tema activo",
      weekShort: "Semana {week}",
      psychologistTitle: "Entrenamiento Mental™",
      psychologistPanelTitle: "Programa de desarrollo mental",
      psychologistHint:
        "Todos los deportistas del equipo reciben el mismo tema esta semana. Puedes reforzarlo en sesión.",
      phases: {
        self_knowledge: "Autoconocimiento",
        goals: "Objetivos",
        attention: "Atención y concentración",
        error_management: "Gestión del error",
        confidence: "Confianza",
        communication: "Comunicación",
        competitive_pressure: "Presión competitiva",
        resilience: "Resiliencia",
        season_finale: "Tramo final de temporada",
      },
      types: {
        reflection: "Reflexión",
        mini_challenge: "Mini reto",
        breathing: "Respiración",
        visualization: "Visualización",
        attention_exercise: "Ejercicio de atención",
        communication_challenge: "Reto de comunicación",
        confidence_exercise: "Ejercicio de confianza",
        mental_routine: "Rutina mental",
      },
    },
    ...
    insights: {
      badge: "Interpretación IA",
      aiLabel: "IA",
      loading: "Generando interpretación IA...",
      footerEnhanced:
        "Interpretación IA en lenguaje natural, combinada con métricas, observaciones y tendencias recientes.",
      footer:
      ...
      athleteTitle: "Lectura del seguimiento",
      ...
      athlete: {
        ...
        stableWithNotes:
          "{name} se mantiene estable (ánimo medio {mood}/10, energía {energy}/10 en 7 días) y ha dejado notas recientes. Revisa el seguimiento individual si procede.",
        healthy:
    ...
    command: {
      ...
      todayLabel: "Hoy tienes:",
      statPriorityAlerts: "avisos prioritarios",
      statAppointments: "citas pendientes",
      statMessages: "mensajes nuevos",
      statAthletes: "deportistas activos",
      statCompliance: "revisiones completadas esta semana",
      prioritiesTitle: "Prioridades de hoy",
      prioritiesEmpty: "Todo al día. No tienes prioridades pendientes en este momento.",
      markReviewed: "Marcar como revisada",
      dismissPriority: "Descartar",
      showHistory: "Ver historial de prioridades",
      hideHistory: "Ocultar historial",
      statusReviewed: "Revisada",
      statusDismissed: "Descartada",
      teamsTitle: "Equipos",
      priority: {
        teamCriticalReview: "🔴 El equipo {team} requiere revisión inmediata.",
        teamObservationReview: "🟠 El equipo {team} tiene varios deportistas en observación.",
        teamPendingReview: "🟠 {count} deportistas de {team} no han completado la revisión esta semana.",
        teamPendingReviewOne: "🟠 1 deportista de {team} no ha completado la revisión esta semana.",
        athletesPendingReview: "🟠 {count} deportistas no han completado la revisión esta semana.",
        athletesPendingReviewOne: "🟠 1 deportista no ha completado la revisión esta semana.",
        appointmentPending: "📅 {count} citas pendientes.",
        appointmentPendingOne: "📅 1 cita pendiente.",
        appointmentPendingAthlete: "📅 Cita pendiente de {name}.",
        messagesUnread: "📩 {count} mensajes sin leer.",
        messagesUnreadOne: "📩 1 mensaje sin leer.",
        messageUnreadFrom: "📩 Mensaje sin leer de {name}.",
        priorityAlerts: "🔴 {count} avisos prioritarios activos.",
        priorityAlertOne: "🔴 1 aviso prioritario activo.",
        priorityAlertAthlete: "🔴 Aviso prioritario: {name}.",
        priorityNoticeAthlete: "🔴 Aviso: {name}.",
        teamMostChanged: "📈 El equipo {team} ha cambiado más esta semana.",
      },
    },

    reminders: {
      title: "Seguimientos pendientes",
      subtitle: "Situaciones leves que se resuelven solas cuando el deportista actúa. No requieren revisión manual.",
    },
    ...
    psychologist: {
      ...
      teamPanelSubtitle: "Selecciona un deportista para ver su historial de seguimiento.",
      openTeam: "Ver equipo",
      selectAthleteTitle: "Evolución del deportista",
      selectAthleteText: "Elige un deportista de la lista para ver su historial de seguimiento.",
      ...
      filterSubtitle: "Centra el seguimiento en un grupo concreto.",
      ...
      actionAlerts: "Avisos",
      actionAlertsSubtitle: "Situaciones que requieren una decisión o intervención.",
      ...
      noActiveAlerts: "Sin avisos activos en este momento.",
    ...
    athleteFile: {
      ...
      tab: {
        ...
        appointments: "Citas",
        messages: "Mensajes",
        alerts: "Historial de avisos",
      },
      summary: {
        title: "Resumen del seguimiento",
        followUpStarted: "Seguimiento iniciado: {date}",
        noFollowUpStart: "Aún no hay fecha de inicio de seguimiento",
        lastReview: "Última revisión: {when}",
        today: "hoy",
        yesterday: "ayer",
        daysAgo: "hace {count} días",
        noReviews: "Todavía no hay revisiones",
        completedReviews: "{count} revisiones completadas",
        adherence: "Adherencia: {pct}%",
        sessions: "{count} sesiones registradas",
        noSessions: "No hay sesiones registradas",
        activePlans: "{count} plan(es) de acción activo(s)",
        noActivePlans: "No hay planes de acción activos",
        pendingAlerts: "{count} aviso(s) pendiente(s) de revisión",
        noPendingAlerts: "Ningún aviso pendiente",
      },
      banner: {
        title: "AVISO ACTIVO",
        viewEvolution: "Ver evolución",
        markReviewed: "Marcar como revisado",
        addAction: "Registrar actuación",
        dismiss: "Descartar aviso",
        dismissBanner: "Cerrar",
        closeNotice: "Cerrar aviso",
        postpone: "Posponer",
        postpone3: "Posponer 3 días",
        postpone7: "Posponer 7 días",
        createSession: "Crear sesión",
        openPlan: "Abrir plan de acción",
        detectedDaysAgo: "Detectado hace {count} días",
        eventCount: "{count} actualizaciones",
      },
      priority: {
        high: "Alta",
        medium: "Media",
      ...
      history: {
        filtersLabel: "Filtrar historial de avisos",
        empty: "No hay avisos en este filtro.",
        reason: "Motivo",
        criterion: "Criterio",
        priority: "Prioridad",
        lastUpdate: "Última actualización",
        eventCount: "Actualizaciones",
        reviewedAt: "Revisado el",
        resolvedAt: "Resuelto el",
        actionTaken: "Acción realizada",
        professionalNote: "Observación profesional",
        reviewedBy: "Revisado por",
        reviewedByPsych: "Psicólogo/a del club",
        noAction: "Sin actuación registrada",
        actionPlaceholder: "Ej. Sesión individual realizada",
        notePlaceholder: "Observación opcional",
        newStatus: "Nuevo estado",
        saveAction: "Guardar actuación",
        filter: {
          all: "Todos",
          active: "Activos",
      ...
      alertCriterion: {
        daysValue: "Valor {value} durante {days} días",
        deltaBaseline: "Cambio de {delta} respecto a la línea base ({baseline})",
        value: "Valor detectado: {value}",
        days: "Durante {days} días",
        generic: "Criterio de la regla de detección",
      },
      noNotes: "Sin observaciones profesionales todavía.",
      noAppointments: "Sin solicitudes de consulta.",
      noMessages: "Sin mensajes.",
      notesNewTitle: "Nueva observación profesional",
      notesEditTitle: "Editar nota",
      notesDate: "Fecha",
      notesTopic: "Tema",
      notesTopicPlaceholder: "Motivo de la sesión o seguimiento",
      notesActions: "Acciones",
      notesActionsPlaceholder: "Acciones del plan de acción",
      ...
      notesDeleteConfirm: "¿Eliminar esta observación?",
      ...
      plan: {
        newGoal: "Nuevo objetivo del plan de acción",
        ...
        noGoals: "Sin plan de acción activo.",
        goalStatus: {
          active: "Activo",
          achieved: "Logrado",
          paused: "Pausado",
      ...
      sessions: {
        newTitle: "Nueva sesión de seguimiento",
        ...
        empty: "Sin sesiones de seguimiento registradas.",
        deleteConfirm: "¿Eliminar esta sesión de seguimiento?",
      },
      documents: {
        uploadTitle: "Subir documento",
        title: "Título",
        titlePlaceholder: "Ej. Informe externo, consentimiento firmado",
        file: "Archivo",
      ...
      messages: {
        threadLabel: "Conversación profesional",
        fromPsychologist: "Psicólogo/a",
    ...
    resources: {
      ...
      subtitle: "Ejercicios, audios, PDFs y rutinas para asignar en los planes de acción.",
      fieldTitle: "Título",
  ...
  ca: {
    ...
    productAnalytics: {
      title: "Product Analytics",
      subtitle: "Mètriques internes d'ús de la plataforma. Només equip de producte.",
      privacyNote: "Dades agregades i anònimes. Mai inclou informació psicològica individual.",
      errorTitle: "No s'ha pogut carregar el panell",
      errorBody: "Executa supabase/product-analytics.sql i marca el teu perfil com a administrador de plataforma.",
      insightsTitle: "Insights",
      insightsSubtitle: "Anomalies i senyals automàtiques per millorar el producte.",
      byClub: "Per club",
      byTeam: "Per equip",
      topTopics: "Temes més vistos",
      noData: "Sense dades suficients en aquest període.",
      featuresEmpty: "Encara no hi ha esdeveniments de funcionalitats registrats.",
      navigationEmpty: "Encara no hi ha dades de navegació.",
      col: {
        club: "Club",
        team: "Equip",
      ...
      kpi: {
        completion: "Compliment setmanal",
        medianReview: "Mediana revisió",
        avgReview: "Mitjana revisió",
        fastestReview: "Més ràpida",
        slowestReview: "Més lenta",
        abandonRate: "Abandonament",
        activeAthletes: "Esportistes",
        activeClubs: "Clubs actius",
        teams: "Equips",
        psychologists: "Psicòlegs",
        coaches: "Entrenadors",
        mtShown: "Entrenament mostrat",
        mtRead: "Lectura >3s",
        mtDismissed: "Descartat",
        apptTotal: "Cites",
        apptPending: "Pendents",
        apptCompleted: "Completades",
        apptCancelled: "Cancel·lades",
        msgTotal: "Missatges",
        msgFromAthletes: "D'esportistes",
        msgFromPsych: "De psicòlegs",
        msgUnread: "Sense llegir",
        alertsGenerated: "Avisos generats",
        alertsResolved: "Avisos revisats",
        prioritiesReviewed: "Prioritats revisades",
        dau: "DAU (sessions)",
        wau: "WAU (sessions)",
        mau: "MAU (sessions)",
        completedReviews: "Revisions completades",
        skippedWeeks: "Setmanes omeses (est.)",
        retentionWeekly: "Retenció setmanal",
        missedTwoWeeks: "Sense 2 setmanes",
        growthAthletes7d: "Alta esportistes 7d",
        growthAthletes30d: "Alta esportistes 30d",
        growthClubs30d: "Alta clubs 30d",
        growthTeams30d: "Alta equips 30d",
        psychWau: "Psicòlegs WAU",
        psychViews: "Vistes psicòleg",
        psychNotes: "Notes creades",
        coachWau: "Entrenadors WAU",
        coachViews: "Vistes entrenador",
        coachRecs: "Recomanacions",
      },
      sections: {
        engagement: "Engagement esportista",
        engagementHint: "Taxa de revisió setmanal completada.",
        reviewCompletion: "Compliment de revisió",
        reviewGoal: "Objectiu: menys de 60 segons.",
        athleteActivity: "Activitat de l'esportista",
        athleteActivityHint: "Sessions anònimes i participació agregada.",
        mentalTraining: "Entrenament Mental™",
        mentalTrainingHint: "Exposició i lectura (esdeveniments anònims).",
        platformHealth: "Salut de la plataforma",
        platformHealthHint: "Clubs, equips, rols i creixement.",
        psychActivity: "Activitat del psicòleg",
        coachActivity: "Activitat de l'entrenador",
        appointments: "Cites",
        messages: "Missatges",
        alerts: "Alertes i prioritats",
        featureAdoption: "Adopció de funcionalitats",
        featureAdoptionHint: "Esdeveniments d'ús per funcionalitat.",
        navigation: "Navegació",
        navigationHint: "Pàgines més visitades (anònim).",
      },
      insight: {
        stable: "No es detecten anomalies rellevants aquesta setmana.",
        completionDrop: "La taxa de compliment ha baixat un {delta}% respecte a la setmana anterior.",
        completionUp: "La taxa de compliment ha pujat un {delta}% respecte a la setmana anterior.",
        reviewSlow: "La mediana de temps de revisió supera l'objectiu ({seconds}s).",
        reviewAbandon: "El {pct}% de revisions iniciades no es completen.",
        abandonStep: "La majoria d'abandonaments ocorren al voltant del pas {step}.",
        missedTwoWeeks: "El {pct}% d'esportistes amb historial porten dues setmanes sense revisar.",
        appointmentsPending: "Hi ha {count} sol·licituds de cita pendents sense resoldre.",
        mentalTrainingEngagement: "El {pct}% de targetes d'Entrenament Mental es llegeixen més de 3 segons.",
        unreadMessages: "Hi ha {count} missatges sense llegir acumulats.",
      },
    },
    ...
    privacy: {
      ...
      psychologistView:
        "El/la psicòleg/òloga té accés professional complet per seguiment, alertes i exportació autoritzada.",
      minors:
    ...
    teams: {
      ...
      headerSummary: "{teams} equips · {athletes} esportistes",
      newTeamShort: "+ Nou equip",
      createModalTitle: "Nou equip",
      renameModalTitle: "Reanomenar equip",
      emptyTeams: "Encara no hi ha equips.",
      cardAthletes: "👥 {count} esportistes",
      cardReviewsDone: "{count} revisions setmanals completades",
      cardReviewsDoneGood: "🟢 {count} han completat la revisió aquesta setmana",
      cardNoReviewsThisWeek: "🟡 Ningú ha completat la revisió aquesta setmana",
      cardPending: "{count} pendents",
      cardPendingGood: "🟡 {count} pendents",
      cardAlerts: "{count} avisos",
      cardAlertsGood: "🔴 {count} avís de seguiment",
      copyInvitation: "📋 Copiar invitació",
      copyInvitationShort: "Copiar invitació",
      invitationCopied: "✔ Invitació copiada",
      invitationCopiedShort: "✔ Copiada",
      viewTeam: "Veure equip",
      metricMental: "Estat mental mitjà",
      metricWellbeing: "Benestar",
      metricSocial: "Cohesió social",
      metricCoach: "Comunicació entrenador",
      metricEnergy: "Energia",
      lastReviewLabel: "📅 Última revisió rebuda:",
      lastReviewToday: "Avui",
      lastReviewYesterday: "Ahir",
      lastReviewDaysAgo: "Fa {days} dies",
      lastReviewNever: "Mai",
      lastReviewNone: "Sense revisions",
      lastReviewShort: "Última revisió:",
      last7Days: "Darrers 7 dies",
      cardAthletesShort: "{count} esportistes",
      cardParticipation: "{done} aquesta setmana · {pct}%",
      cardPendingShort: "{count} pendents",
      cardAlertsShort: "{count} avisos",
      healthLabel: {
        healthy: "Rendiment estable",
        monitoring: "Seguiment recomanat",
        priority: "Seguiment prioritari",
      },
      metricShort: {
        mental: "Mental",
        wellbeing: "Benestar",
      ...
      trendStableShort: "vs. setmana anterior",
      trendDelta: "{delta} vs. setmana anterior",
      alertFactorsTitle: "⚠ Factors principals",
      alertFactor: {
        mentalLow: "Estat mental per sota del llindar",
        wellbeingLow: "Benestar baix",
        energyLow: "Energia baixa",
        lowParticipation: "Participació setmanal per sota del {pct}%",
        unresolvedAlerts: "{count} avisos sense resoldre",
        mentalDeclining: "Estat mental en descens (−{delta})",
        pendingReviews: "{count} revisions pendents",
      },
      status: {
        stable: "🟢 Equip estable",
        watch: "🟡 Seguiment recomanat",
        observation: "🟠 Diversos esportistes en observació",
        critical: "🔴 Seguiment prioritari",
        unknown: "Sense dades suficients",
      },
      menuActions: "Accions de l'equip",
    ...
    director: {
      ...
      alertsResolved: "Avisos resolts (mes)",
    ...
    reports: {
      exportPdf: "Exportar informe de rendiment psicològic",
      teamReport: "Informe d'equip",
      clubReport: "Informe de club",
      athleteReport: "Informe de rendiment psicològic",
      monthlySubtitle: "Informe agregat — Zona Mental+",
      individualSubtitle: "Informe de rendiment psicològic",
      sectionOverview: "Panorama",
      ...
      disclaimer: "Avís",
      disclaimerText: "Informe de suport a la presa de decisions professionals. No substitueix el judici professional.",
      team: "Equip",
      club: "Club",
      athlete: "Esportista",
      teams: "Equips",
      ...
      sectionAiSummary: "Interpretació IA",
    ...
    athlete: {
      loading: "Preparant la teva revisió...",
      ...
      homeWelcome: "Benvingut/da a la teva revisió setmanal.",
      homeDuration: "Aquest procés només et portarà aproximadament 45 segons.",
      startReview: "Començar revisió",
      weekStatusLabel: "Revisió d'aquesta setmana",
      weekStatusPending: "Pendent",
      weekStatusCompleted: "Completada",
      weekCompletedTitle: "Gràcies!",
      weekCompletedBody: "La revisió d'aquesta setmana ja està completada.",
      weekCompletedSupport:
        "La teva participació ajuda a fer un seguiment continu del teu rendiment mental durant la temporada.",
      completionTitle: "Revisió completada",
      completionThanks: "Gràcies per dedicar aquest temps.",
      completionBody:
        "Cada resposta ajuda el teu psicòleg esportiu a entendre millor la teva evolució durant la temporada.",
      completionHonesty:
        "Recorda: no hi ha respostes correctes o incorrectes. L'honestedat és la part més valuosa del procés.",
      confidentiality:
        "La informació que comparteixes és confidencial i només és accessible pel teu psicòleg esportiu, excepte aquelles recomanacions que decideixi compartir amb l'equip tècnic amb el teu coneixement.",
      actionAppointment: "Sol·licitar una cita",
      actionMessage: "Enviar un missatge",
    ...
    entrenamentMental: {
      title: "Entrenament Mental™",
      tryThisWeek: "Prova-ho aquesta setmana.",
      currentWeek: "Setmana actual",
      currentPhase: "Fase",
      currentTopic: "Tema actiu",
      weekShort: "Setmana {week}",
      psychologistTitle: "Entrenament Mental™",
      psychologistPanelTitle: "Programa de desenvolupament mental",
      psychologistHint:
        "Tots els esportistes de l'equip reben el mateix tema aquesta setmana. Pots reforçar-lo en sessió.",
      phases: {
        self_knowledge: "Autoconeixement",
        goals: "Objectius",
        attention: "Atenció i concentració",
        error_management: "Gestió de l'error",
        confidence: "Confiança",
        communication: "Comunicació",
        competitive_pressure: "Pressió competitiva",
        resilience: "Resiliència",
        season_finale: "Tram final de temporada",
      },
      types: {
        reflection: "Reflexió",
        mini_challenge: "Mini repte",
        breathing: "Respiració",
        visualization: "Visualització",
        attention_exercise: "Exercici d'atenció",
        communication_challenge: "Repte de comunicació",
        confidence_exercise: "Exercici de confiança",
        mental_routine: "Rutina mental",
      },
    },
    ...
    insights: {
      badge: "Interpretació IA",
      aiLabel: "IA",
      loading: "Generant interpretació IA...",
      footerEnhanced:
        "Interpretació IA en llenguatge natural, combinada amb mètriques, observacions i tendències recents.",
      footer:
      ...
      athleteTitle: "Lectura del seguiment",
      ...
      athlete: {
        ...
        stableWithNotes:
          "{name} es manté estable (ànim mitjà {mood}/10, energia {energy}/10 en 7 dies) i ha deixat notes recents. Revisa el seguiment individual si cal.",
        healthy:
    ...
    command: {
      greeting: {
        morning: "Bon dia, {name} 👋",
        afternoon: "Bon vespre, {name} 👋",
        evening: "Bona nit, {name} 👋",
      },
      todayLabel: "Avui tens:",
      statPriorityAlerts: "avisos prioritaris",
      statAppointments: "cites pendents",
      statMessages: "missatges nous",
      statAthletes: "esportistes actius",
      statCompliance: "revisions completades aquesta setmana",
      prioritiesTitle: "Prioritats d'avui",
      prioritiesEmpty: "Tot al dia. No tens prioritats pendents en aquest moment.",
      markReviewed: "Marcar com revisada",
      dismissPriority: "Descartar",
      showHistory: "Veure historial de prioritats",
      hideHistory: "Amagar historial",
      statusReviewed: "Revisada",
      statusDismissed: "Descartada",
      teamsTitle: "Equips",
      priority: {
        teamCriticalReview: "🔴 L'equip {team} requereix revisió immediata.",
        teamObservationReview: "🟠 L'equip {team} té diversos esportistes en observació.",
        teamPendingReview: "🟠 {count} esportistes de {team} no han completat la revisió aquesta setmana.",
        teamPendingReviewOne: "🟠 1 esportista de {team} no ha completat la revisió aquesta setmana.",
        athletesPendingReview: "🟠 {count} esportistes no han completat la revisió aquesta setmana.",
        athletesPendingReviewOne: "🟠 1 esportista no ha completat la revisió aquesta setmana.",
        appointmentPending: "📅 {count} cites pendents.",
        appointmentPendingOne: "📅 1 cita pendent.",
        appointmentPendingAthlete: "📅 Cita pendent de {name}.",
        messagesUnread: "📩 {count} missatges sense llegir.",
        messagesUnreadOne: "📩 1 missatge sense llegir.",
        messageUnreadFrom: "📩 Missatge sense llegir de {name}.",
        priorityAlerts: "🔴 {count} avisos prioritaris actius.",
        priorityAlertOne: "🔴 1 avís prioritari actiu.",
        priorityAlertAthlete: "🔴 Avís prioritari: {name}.",
        priorityNoticeAthlete: "🔴 Avís: {name}.",
        teamMostChanged: "📈 L'equip {team} ha canviat més aquesta setmana.",
      },
    },

    reminders: {
      title: "Seguiments pendents",
      subtitle: "Situacions lleus que es resolen soles quan l'esportista actua. No cal revisar-les manualment.",
    },
    ...
    psychologist: {
      ...
      teamPanelSubtitle: "Selecciona un esportista per veure el seu historial de seguiment.",
      openTeam: "Veure equip",
      selectAthleteTitle: "Evolució de l'esportista",
      selectAthleteText: "Tria un esportista de la llista per veure el seu historial de seguiment.",
      ...
      filterSubtitle: "Centra el seguiment en un grup concret.",
      ...
      actionAlerts: "Avisos",
      actionAlertsSubtitle: "Situacions que requereixen una decisió o intervenció.",
      ...
      noActiveAlerts: "Sense avisos actius en aquest moment.",
    ...
    athleteFile: {
      ...
      tab: {
        ...
        appointments: "Cites",
        messages: "Missatges",
        alerts: "Historial d'avisos",
      },
      summary: {
        title: "Resum del seguiment",
        followUpStarted: "Seguiment iniciat: {date}",
        noFollowUpStart: "Encara no hi ha data d'inici de seguiment",
        lastReview: "Última revisió: {when}",
        today: "avui",
        yesterday: "ahir",
        daysAgo: "fa {count} dies",
        noReviews: "Encara no hi ha revisions",
        completedReviews: "{count} revisions completades",
        adherence: "Adherència: {pct}%",
        sessions: "{count} sessions registrades",
        noSessions: "No hi ha sessions registrades",
        activePlans: "{count} pla(ns) d'acció actiu(s)",
        noActivePlans: "No hi ha plans d'acció actius",
        pendingAlerts: "{count} avís(os) pendent(s) de revisió",
        noPendingAlerts: "Cap avís pendent",
      },
      banner: {
        title: "AVÍS ACTIU",
        viewEvolution: "Veure evolució",
        markReviewed: "Marcar com revisat",
        addAction: "Registrar actuació",
        dismiss: "Descartar avís",
        dismissBanner: "Tancar",
        closeNotice: "Tancar avís",
        postpone: "Posposar",
        postpone3: "Posposar 3 dies",
        postpone7: "Posposar 7 dies",
        createSession: "Crear sessió",
        openPlan: "Obrir pla d'acció",
        detectedDaysAgo: "Detectat fa {count} dies",
        eventCount: "{count} actualitzacions",
      },
      priority: {
        high: "Alta",
        medium: "Mitjana",
      ...
      history: {
        filtersLabel: "Filtrar historial d'avisos",
        empty: "No hi ha avisos en aquest filtre.",
        reason: "Motiu",
        criterion: "Criteri",
        priority: "Prioritat",
        lastUpdate: "Última actualització",
        eventCount: "Actualitzacions",
        reviewedAt: "Revisat el",
        resolvedAt: "Resolt el",
        actionTaken: "Acció realitzada",
        professionalNote: "Observació professional",
        reviewedBy: "Revisat per",
        reviewedByPsych: "Psicòleg/òloga del club",
        noAction: "Sense actuació registrada",
        actionPlaceholder: "Ex. Sessió individual realitzada",
        notePlaceholder: "Observació opcional",
        newStatus: "Nou estat",
        saveAction: "Desar actuació",
        filter: {
          all: "Tots",
          active: "Actius",
          monitoring: "En seguiment",
          resolved: "Resolts",
          dismissed: "Descartats",
        },
      },
      alertCriterion: {
        daysValue: "Valor {value} durant {days} dies",
        deltaBaseline: "Canvi de {delta} respecte a la línia base ({baseline})",
        value: "Valor detectat: {value}",
        days: "Durant {days} dies",
        generic: "Criteri de la regla de detecció",
      },
      noNotes: "Sense observacions professionals encara.",
      noAppointments: "Sense sol·licituds de consulta.",
      noMessages: "Sense missatges.",
      notesNewTitle: "Nova observació professional",
      notesEditTitle: "Editar nota",
      notesDate: "Data",
      notesTopic: "Tema",
      ...
      notesDeleteConfirm: "Eliminar aquesta observació?",
      addNote: "Desar nota",
      save: "Desar canvis",
      saving: "Desant...",
      edit: "Editar",
      ...
      plan: {
        newGoal: "Nou objectiu del pla d'acció",
      ...
      sessions: {
        newTitle: "Nova sessió de seguiment",
        ...
        empty: "Sense sessions de seguiment registrades.",
        deleteConfirm: "Eliminar aquesta sessió de seguiment?",
      },
      documents: {
        uploadTitle: "Pujar document",
        title: "Títol",
        titlePlaceholder: "Ex. Informe extern, consentiment signat",
        file: "Arxiu",
      ...
      messages: {
        threadLabel: "Conversació professional",
        fromPsychologist: "Psicòleg/òloga",
    ...
    resources: {
      title: "Biblioteca de recursos",
      subtitle: "Exercicis, àudios, PDFs i rutines per assignar als plans d'acció.",
      fieldTitle: "Títol",
