export const translations = {
  es: {
    ...
    athlete: {
      ...
      subtitle:
        "Tu resumen de preparación mental. Recomendamos 1-2 autoevaluaciones por semana (unos 2 min cada una).",
      checkInsLogged: "Autoevaluaciones registradas",
      last14Days: "Últimos 14 días",
      latestMood: "Ánimo (último registro)",
      loggedThisWeek: "Registrado esta semana",
      notLoggedThisWeek: "Sin registro esta semana",
      avgEnergy: "Energía media (7d)",
      avgStress: "Estrés medio (7d)",
      recentCheckIns: "Autoevaluaciones recientes",
  ...
  ca: {
    ...
    athlete: {
      ...
      subtitle:
        "El teu resum de preparació mental. Recomanem 1-2 autoavaluacions per setmana (uns 2 min cadascuna).",
      checkInsLogged: "Autoavaluacions registrades",
      last14Days: "Últims 14 dies",
      latestMood: "Ànim (últim registre)",
      loggedThisWeek: "Registrat aquesta setmana",
      notLoggedThisWeek: "Sense registre aquesta setmana",
      avgEnergy: "Energia mitjana (7d)",
      avgStress: "Estrès mitjà (7d)",
      recentCheckIns: "Autoavaluacions recents",
